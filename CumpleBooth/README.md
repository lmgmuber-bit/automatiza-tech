...
Para retomar el proyecto desde otra PC, la fuente de continuidad vigente es
`docs/HANDOFF-OTRA-PC-2026-08-02.md`.
...
Demos locales Full: `?p=demo-carreras`, `?p=demo` (Familia Canina),
`?p=demo-tropical`, `?p=demo-hielo`, `?p=demo-kpop` y `?p=demo-heroes`.
Se crean de forma idempotente con
`php scripts/seed-demo-theme-parties.php --apply`. Las primeras cinco cumplen la
tabla multimedia completa. Héroes ya tiene experiencia, catálogo y Full configurado,
pero no se ofrece como temática completa hasta producir sus saludos y despedida.
