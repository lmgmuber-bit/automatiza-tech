...
> **CIERRE CANÓNICO 2026-08-02 — continuidad entre PCs.** Antes de usar los
> estados históricos de este archivo, leer completo
> `docs/HANDOFF-OTRA-PC-2026-08-02.md`. Allí están la rama remota, comandos de
> recuperación, arquitectura vigente, seis mundos Full, diferencia entre los cinco
> temas multimedia completos y Héroes, sitio/leads, Gate A, video estrella con audio,
> gates finales, exclusiones y reglas de deploy. Las listas antiguas de “pendientes”
> de este documento son historial y quedan reemplazadas cuando contradicen ese cierre.
...
> WhatsApp sigue intencionalmente pendiente para el último gate. En el cierre
> 2026-08-02 se actualizó la aserción histórica de `mundo3d` al contrato vigente
> `concierto3d`; la suite general quedó verde en las cuatro versiones PHP.
