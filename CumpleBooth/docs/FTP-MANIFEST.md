...
## Build de cierre 2026-08-02 — fuente vigente

Estado: **solo local, no desplegado**. Para evitar combinaciones incompatibles, la
entrega recomendada es subir `dist/` completo en una misma ventana. Los bundles del
build vigente son:

| Orden | Ruta local exacta | Destino PROD relativo | Clase |
|---:|---|---|---|
| 1 | `CumpleBooth/dist/assets/baloo-2-latin-600-normal-tIfxVoAe.woff2` | `/public_html/cumpleclick/assets/baloo-2-latin-600-normal-tIfxVoAe.woff2` | OBLIGATORIO |
| 2 | `CumpleBooth/dist/assets/baloo-2-latin-700-normal-CqTg7A15.woff2` | `/public_html/cumpleclick/assets/baloo-2-latin-700-normal-CqTg7A15.woff2` | OBLIGATORIO |
| 3 | `CumpleBooth/dist/assets/baloo-2-latin-800-normal-BbF3Etk1.woff2` | `/public_html/cumpleclick/assets/baloo-2-latin-800-normal-BbF3Etk1.woff2` | OBLIGATORIO |
| 4 | `CumpleBooth/dist/assets/three.module-Y-ql4QRg.js` | `/public_html/cumpleclick/assets/three.module-Y-ql4QRg.js` | OBLIGATORIO |
| 5 | `CumpleBooth/dist/assets/index-CZI7g5Bd.js` | `/public_html/cumpleclick/assets/index-CZI7g5Bd.js` | OBLIGATORIO — JS del kiosco vigente |
| 6 | `CumpleBooth/dist/assets/index-BUdcCfFe.css` | `/public_html/cumpleclick/assets/index-BUdcCfFe.css` | OBLIGATORIO — CSS vigente |
| 7 | `CumpleBooth/dist/themes/carreras/rayo-mcqueen-estrella.mp4` | `/public_html/cumpleclick/themes/carreras/rayo-mcqueen-estrella.mp4` | OBLIGATORIO — Show Full con AAC; SHA-256 `50CFACD7C91E6A10E99B06540BC5C2607BE3ACAD5B76106FD9CA445146FF00D4` |
| 8 | `CumpleBooth/dist/**` restante | `/public_html/cumpleclick/` conservando rutas | OBLIGATORIO — PHP, JSON, assets y seis mundos del mismo build |
| 9 | `CumpleBooth/dist/index.html` | `/public_html/cumpleclick/index.html` | OBLIGATORIO — subir último |

El sitio comercial `CumpleBooth/sitio/**` se despliega por separado solo cuando Luis
confirme su URL y el número oficial de WhatsApp. La migración `006_public_leads` y
scripts privados se ejecutan fuera de `public_html` según `docs/DEPLOY.md`.

No subir `src/`, `tests/`, `docs/`, `design/`, `graphify-out/`, `qa-evidence/`,
`tmp/`, configuración real, BD, dumps, backups, fotos ni `storage/`.
