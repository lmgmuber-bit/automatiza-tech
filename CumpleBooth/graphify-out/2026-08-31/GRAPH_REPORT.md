# Graph Report - CumpleBooth  (2026-08-26)

## Corpus Check
- 214 files · ~24,505,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1909 nodes · 2443 edges · 217 communities (195 shown, 22 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e041a404`
...
- _at-verificar.php
- cb_build_theme_payload
- cb_save_parties

## God Nodes (most connected - your core abstractions)
1. `cb_pdo()` - 39 edges
2. `cb_storage_mode()` - 35 edges
3. `cb_album_require_db()` - 22 edges
4. `CumpleClick (nombre técnico del repo/carpeta: CumpleBooth) — Traspaso completo para Codex / OpenCode` - 17 edges
5. `cb_event_profile_require_db()` - 16 edges
6. `main()` - 16 edges
...
10. `Handoff a Claude — CumpleClick: invitaciones inmersivas y campaña promocional` - 14 edges
...
### Community 0 - "cb_pdo"
Cohesion: 0.15
Nodes (32): cb_album_feature_ready(), cb_pdo(), cb_storage_mode(), cb_create_invitation(), cb_create_visual_manifest(), cb_default_invitation_prompt_template(), cb_delete_invitation(), cb_delete_invitation_output() (+24 more)
...
### Community 4 - "App.jsx"
Cohesion: 0.07
Nodes (26): audio, BoothApp(), brandLogoCache, CARRERAS_CUT_CON_AIRE, CHAR_IMG, CHAR_JUEGO_AUDIO, CHAR_PNG, CHAR_RUN_ATLAS (+18 more)
...
Cohesion: 0.24
Nodes (9): cb_hmac(), cb_valid_galeria_pin(), cb_verify_party_pin(), cb_invitation_preview_mac(), cb_invitation_preview_ok(), cb_invitation_share_token(), cb_create_lead(), cb_lead_text() (+1 more)
...
Cohesion: 0.31
Nodes (8): GAME_KINDS, GAME_LABEL_POR_DEFECTO, optionalAsset(), resolveGame(), resolveThemeFlow(), BABY_SHOWER, COMPLETAS, HOMOLOGADAS
...
Cohesion: 0.12
Nodes (35): cb_compile_invitation_prompt(), cb_config(), cb_game_kinds(), cb_inspect_video(), cb_invitation_dir(), cb_load_theme_prompt_history(), cb_load_theme_prompts(), cb_parse_theme_prompts_markdown() (+27 more)
...
Cohesion: 0.11
Nodes (33): cb_album_active_token_info(), cb_album_ensure(), cb_album_find_by_id(), cb_album_find_by_party(), cb_album_find_media(), cb_album_find_media_by_token(), cb_album_inspect_video(), cb_album_issue_token() (+25 more)
...
Cohesion: 0.11
Nodes (17): Baby shower: qué es una temática completa (2026-08-26), Cadena de juegos por personaje, Cómo se calibra el frameBox, Estado al 2026-08-26, Estado hoy (2026-08-01), La misión Full, Lo que NO hace falta, Orden de producción sugerido (+9 more)
...
### Community 191 - "cb_public_base_url"
Cohesion: 0.11
Nodes (20): admin_base_url(), cb_album_intake_url(), cb_album_sign_url(), cb_album_view_url(), cb_hash_token(), cb_opaque_token(), cb_public_base_url(), cb_invitation_download_url() (+12 more)
...
### Community 196 - "cb_state_path"
Cohesion: 0.21
Nodes (13): cb_find_photo_by_token(), cb_generate_public_slug(), cb_list_party_photos(), cb_load_json_file(), cb_mutate_json_state(), cb_photo_usage(), cb_rate_limit(), cb_record_photo() (+5 more)
...
### Community 204 - "cb_build_theme_payload"
Cohesion: 0.40
Nodes (5): cb_build_theme_payload(), cb_sanitize_theme_game(), cb_themes_dir(), cc_build_demos(), cc_tema_terminado()

### Community 216 - "cb_save_parties"
Cohesion: 0.27
...
- **Why does `applyThemeColors()` connect `album/main.jsx` to `composeImage`, `Preview`, `App.jsx`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `cb_pdo()` connect `cb_pdo` to `cb_state_path`, `lib.event-profiles.php`, `lib.php`, `lib.album.php`, `cb_hmac`, `cb_save_parties`, `cb_public_base_url`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `cb_storage_mode()` connect `cb_pdo` to `cb_state_path`, `lib.event-profiles.php`, `lib.php`, `lib.album.php`, `cb_hmac`, `cb_save_parties`, `cb_public_base_url`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Are the 27 inferred relationships involving `cb_pdo()` (e.g. with `cb_album_feature_ready()` and `cb_album_require_db()`) actually correct?**
  _`cb_pdo()` has 27 INFERRED edges - model-reasoned connections that need verification._
- **Are the 25 inferred relationships involving `cb_storage_mode()` (e.g. with `cb_album_feature_ready()` and `cb_album_require_db()`) actually correct?**
  _`cb_storage_mode()` has 25 INFERRED edges - model-reasoned connections that need verification._
