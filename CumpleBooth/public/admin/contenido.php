...
.contenido-preview{display:block;max-width:100%;max-height:380px;object-fit:contain;margin:16px auto;border-radius:var(--radius-sm);background:var(--bg2)}.contenido-seccion input[type=file]{display:block;width:100%;max-width:100%;min-width:0;font:inherit;font-size:.85rem}.contenido-texto{width:100%;min-height:190px;resize:vertical;border:1px solid var(--border);border-radius:var(--radius-sm);padding:12px;font:inherit;color:var(--text);background:var(--bg2)}.contenido-estado{padding:6px 14px;border-radius:25px;background:var(--primary-soft);font-weight:700;display:inline-block}
