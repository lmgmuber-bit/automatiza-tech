 ...
 * (`Tio-Pepe.jpg`), así que las fotos se agrupan contra la lista de invitados
...
{
    // Cualquier extension de imagen, no solo .png: el kiosco pasó a componer en JPEG
    // (un PNG de 1080x1920 pesa 2,2 MB y el mismo lienzo en JPEG 350 KB) y con el
    // patrón viejo "Emilia.jpg" no calzaba con la invitada Emilia y caía en
    // "no está en la lista".
    $base = preg_replace('/\.(png|jpe?g|webp)$/i', '', $name);
 ...
 * la lista y "Tio-Pepe.jpg" en el archivo tienen que caer en la misma clave.
 */
