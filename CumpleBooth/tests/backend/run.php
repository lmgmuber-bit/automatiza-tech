...
$seisShowsFull = [
    'carreras' => 'podium-night',
    'familia-canina' => 'backyard-fiesta',
    'tropical' => 'beach-luau',
    'hielo' => 'ice-gala',
    'kpop' => 'neon-arena',
    'heroes' => 'rooftop-city',
];
foreach ($seisShowsFull as $slug => $stage) {
    ...
    check(
        ($fullPayload['fullGame']['kind'] ?? '') === 'concierto3d'
        && ($fullPayload['fullGame']['stage'] ?? '') === $stage,
        $slug . ': Full recibe su Show y escenario correctos'
    );
