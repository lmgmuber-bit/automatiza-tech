...
Toda propuesta de cliente usa la plantilla única del `propuesta-renderer` (regla de Luis, 2026-09-23), nunca Gamma: `Docs/METODO_AT/PROPUESTAS-PLANTILLA-UNICA.md`.
