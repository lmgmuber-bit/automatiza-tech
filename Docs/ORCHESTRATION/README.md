...
14. **Deploy a PROD de AT lo ejecuta Luis manualmente.** Los agentes NO suben archivos al hosting: preparan el paquete exacto (lista de archivos, rutas destino, pasos de instalacion y verificacion post-subida) y avisan cuando esta OK. Git debe mantenerse actualizado: cada alcance/ticket se commitea en su rama correspondiente apenas queda estable; nunca commits masivos de alcances mezclados.
