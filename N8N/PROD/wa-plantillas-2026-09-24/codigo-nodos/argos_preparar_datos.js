...
// Body para WhatsApp API (plantilla alerta_argos; el boton "Ver panel de errores" es fijo y no lleva parametros)
const whatsappBody = {
...
// WhatsApp una sola vez por cada error (Luis, 24-sep): solo si no hay un error igual
