...
BOTONES = {"type": "BUTTONS", "buttons": [
    {"type": "QUICK_REPLY", "text": "S\u00ed, confirmo"},
    {"type": "QUICK_REPLY", "text": "No podr\u00e9"},
]}

PLANTILLAS = [
    {
        "name": "recordatorio_cita_72h", "language": "es", "category": "UTILITY",
        "components": [
            {"type": "BODY",
             "text": ("\U0001F44B *\u00a1Hola {{1}}!*\n\n"
                      "Te recordamos que tienes una cita agendada con AutomatizaTech.\n\n"
                      "\U0001F4C6 *Fecha:* {{2}}\n"
                      "\U0001F550 *Hora:* {{3}} hrs\n\n"
                      "\u00bfPodr\u00e1s asistir? Por favor confirma para reservar tu espacio."),
             "example": {"body_text": [["Mar\u00eda", "28-09-2026", "15:00"]]}},
            BOTONES,
        ],
    },
    {
        "name": "recordatorio_cita_24h", "language": "es", "category": "UTILITY",
        "components": [
            {"type": "BODY",
             "text": ("\U0001F4C5 *Recordatorio de tu cita*\n\n"
                      "Hola {{1}}, te recordamos que tienes una reuni\u00f3n agendada con AutomatizaTech.\n\n"
                      "\U0001F4C6 *Fecha:* {{2}}\n"
                      "\U0001F550 *Hora:* {{3}} hrs\n"
                      "\U0001F4CD *Enlace:* {{4}}\n\n"
                      "\u00bfPodr\u00e1s asistir?"),
             "example": {"body_text": [["Mar\u00eda", "25-09-2026", "15:00", MEET_EJ]]}},
            BOTONES,
        ],
    },
    {
        "name": "recordatorio_cita_1h", "language": "es", "category": "UTILITY",
        "components": [
            {"type": "BODY",
             "text": ("\u23F0 *\u00a1Tu cita es en {{1}}!*\n\n"
                      "Hola {{2}}, te recordamos que tu reuni\u00f3n con AutomatizaTech est\u00e1 programada para hoy.\n\n"
                      "\U0001F4C5 *Fecha:* {{3}}\n"
                      "\U0001F550 *Hora:* {{4}} hrs\n"
                      "\U0001F4CD *Enlace:* {{5}}\n\n"
                      "\u00bfPodr\u00e1s asistir?"),
             "example": {"body_text": [["1 hora", "Mar\u00eda", "25-09-2026", "15:00", MEET_EJ]]}},
            BOTONES,
        ],
    },
]
