...
class AutomatizaTechContactForm {
    ...
    private function send_contracted_client_email($client_data, $plans_data = null) {
        ...
        $headers = array(
            'Content-Type: text/html; charset=UTF-8',
            'From: AutomatizaTech <info@automatizatech.cl>',
            'Reply-To: info@automatizatech.cl'
        );
...
<body>
    <div class='email-container'>
        ...
        $message .= "            <p class='message-text'>
            ...
            <div class='support-box'>
                ...
                <div class='contact-info'>
                    Email: <strong>info@automatizatech.cl</strong><br>
        ...
        <div class='email-footer'>
            ...
            <p style='font-size: 0.85em; margin-top: 15px;'>
                {$site_url} | info@automatizatech.cl<br>
        ...
        add_action('phpmailer_init', function($phpmailer) use ($client_data, $plans_data, $invoice_number, $site_url) {
            ...
            $plain_text .= "-----------------------\n";
            $plain_text .= "Email: info@automatizatech.cl\n";
    ...
    public function configure_smtp($phpmailer) {
        ...
        $phpmailer->From     = 'info@automatizatech.cl';
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f4f4f4; padding: 20px 0;">
        ...
        $message .= '
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 25px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="mailto:info@automatizatech.cl?subject=Consulta sobre Cotizacion ' . $quotation_number . '" style="display: inline-block; background: linear-gradient(135deg, #0047AB 0%, #00CED1 100%); color: #ffffff; text-decoration: none; padding: 14px 30px; border-radius: 6px; font-weight: bold; font-size: 15px;">
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 20px 30px; border-top: 1px solid #e5e7eb; text-align: center;">
                            ...
                            <p style="margin: 0 0 5px 0; color: #6b7280; font-size: 12px;">info@automatizatech.cl</p>
