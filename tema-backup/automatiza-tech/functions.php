...
function get_whatsapp_url($message = '') {
    $number = get_theme_mod('whatsapp_number', '+56927002984');
...
function automatiza_tech_contact_form_shortcode() {
    ...
    <form id="contact-form" class="contact-form">
        ...
        <div class="form-group">
            ...
            <textarea id="message" name="message" rows="5" required placeholder="Cuéntanos sobre tu proyecto y cómo podemos ayudarte..."></textarea>
        </div>
