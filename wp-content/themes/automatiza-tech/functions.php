...
function automatiza_tech_setup() {
    // Soporte para tÃ­tulo automÃ¡tico
    ...
    register_nav_menus(array(
        'primary' => __('MenÃº Principal', 'automatiza-tech'),
        'footer'  => __('MenÃº Footer', 'automatiza-tech'),
    ));
...
function automatiza_tech_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('whatsapp_number', array(
        'label'   => __('NÃºmero de WhatsApp', 'automatiza-tech'),
    ...
    $wp_customize->add_control('hero_title', array(
        'label'   => __('TÃ­tulo Principal', 'automatiza-tech'),
        'section' => 'automatiza_tech_options',
        'type'    => 'text',
    ));
    ...
    $wp_customize->add_control('hero_subtitle', array(
        'label'   => __('SubtÃ­tulo', 'automatiza-tech'),
        'section' => 'automatiza_tech_options',
        'type'    => 'text',
    ));
...
/**
 * Optimizaciones SEO bÃ¡sicas
 */
function automatiza_tech_seo_optimizations() {
    // Meta tags bÃ¡sicos
    add_action('wp_head', function() {
        if (is_front_page()) {
            echo '<meta name="description" content="Automatiza Tech - Conectamos tus ventas, web y CRM. Bots inteligentes para negocios que no se detienen. Mejora tu atenciÃ³n al cliente 24/7.">';
            echo '<meta name="keywords" content="automatizaciÃ³n, chatbots, CRM, ventas, WhatsApp, Instagram, atenciÃ³n al cliente">';
            echo '<meta property="og:title" content="Automatiza Tech - Conectamos tus ventas, web y CRM">';
            echo '<meta property="og:description" content="Bots inteligentes para negocios que no se detienen. Automatiza tu atenciÃ³n, ahorra tiempo, escala tu negocio.">';
...
// Incluir configuraciÃ³n de desarrollo si estamos en localhost
...
/**
 * Incluir funcionalidad del formulario de contacto
 */
